...
// Read file contents
func readPythonContent(location *model.Location, req *common.ParserParams) {
...
func readPoetryContent(location *model.Location, req *common.ParserParams) {
...
func readRequirementsContent(location *model.Location, req *common.ParserParams) {

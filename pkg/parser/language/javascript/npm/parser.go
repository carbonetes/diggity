...
// Read file contents
func readNpmContent(location *model.Location, req *common.ParserParams) {
...
// Parse lock content
func readNpmLockContent(location *model.Location, req *common.ParserParams) {
...
func readYarnLockContent(location *model.Location, req *common.ParserParams) {

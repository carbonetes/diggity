...
func parseConanFilePackages(location *model.Location, req *bom.ParserRequirements) {
...
func parseConanLockPackages(location *model.Location, req *bom.ParserRequirements) {

...
type HexMetadata metadata.HexMetadata
...
func parseHexPURL(_package *model.Package) {
	_package.PURL = model.PURL(scheme + ":" + "hex" + "/" + _package.Name + "@" + _package.Version)
}
